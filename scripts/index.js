...
const giftBox = document.getElementById('merry-wrap');
const canvasC = document.getElementById('c');

const config = {
  birthdate: 'Feb 17, 2023',
  name: 'ROMA'
};
    ...
    let w = (c.width = window.innerWidth),
        ...
        Letter.prototype.step = function() {
          ...
          function goToNextPage() {
            window.location.replace = "https://www.encodedna.com/javascript/operators/default.htm";
          }
          ...
          function anim() {
            ...
            if (done) location.replace("card.html");
          }
          ...
          if (distance > 0) {
            ...
            clearInterval(x);
            let merryWrap = document.getElementById('merry-wrap');
            let box = merryWrap.getElementsByClassName('gift-box')[0];
            let step = 1;
            ...
            function stepClass(step) {
              merryWrap.className = 'merry-wrap';
              merryWrap.className = 'merry-wrap step-' + step;
            }
